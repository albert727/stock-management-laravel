...
if (empty($dari) || empty($sampai)) {
    $_SESSION['error'] = "Silakan tentukan rentang tanggal terlebih dahulu sebelum mencetak laporan.";
...
$pdf->Cell(190, 6, "Periode: " . format_tanggal($dari) . " s/d " . format_tanggal($sampai), 0, 1, 'C');
$pdf->Ln(10);
