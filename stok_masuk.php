        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                    <h1 class="mt-4 text-success">PRODUK MASUK</h1>
                        ...
                        <div clas="card-header">
                            ...
                            <div class="card mb-4">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    ...
                                    <i class="fas fa-arrow-down"></i> Tambah Stok Produk
                                    </button>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            <?php
                                            $ambil = mysqli_query($conn, "SELECT m.*, s.nama_produk 
                                              FROM tb_masuk m 
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?= $nama_produk; ?></td>
                                                    <td><?= $keterangan; ?></td>
                                                    <td class="text-center"><?= $stokmasuk; ?></td>
                                                </tr>
                                            <?php
                                            }
                                            ?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h4 class="modal-title">Stok Masuk Produk</h4>
            ...
            <form method="post">
                <div class="modal-body">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="keterangan" id="keterangan" placeholder="Masukkan nama" class="form-control" required>
                    </div>
                    ...
                    <div class="d-flex justify-content-end">
                        <button type="submit" class="btn btn-primary" name="stokmasuk">Submit</button>
                    </div>
                </div>
            </form>
        </div>
